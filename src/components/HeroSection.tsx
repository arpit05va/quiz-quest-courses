          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 mb-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground font-medium">50K+ Students</span>
              </div>
              <div className="flex items-center space-x-2">
                <BookOpen className="w-5 h-5 text-primary-500" />
                <span className="text-muted-foreground font-medium">200+ Courses</span>
              </div>
              <div className="flex items-center space-x-2">
                <Star className="w-5 h-5 text-yellow-500" />
                <span className="text-muted-foreground font-medium">4.8 Rating</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-2 border-border hover:border-primary-500 px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300"
              >
