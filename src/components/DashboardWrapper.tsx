            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/student?tab=job-discovery")
                    }
                  >
                    <Search className="w-4 h-4 mr-2" />
                    AI Job Discovery
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/student?tab=application-tracker")
                    }
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/student?tab=profile-resume")
                    }
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/student?tab=interview-prep")
                    }
                  >
                    <Calendar className="w-4 h-4 mr-2" />
                    Interview Prep
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/student?tab=career-insights")
                    }
                  >
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/recruiter?tab=candidate-discovery")
                    }
                  >
                    <Search className="w-4 h-4 mr-2" />
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/recruiter?tab=job-posting")
                    }
                  >
                    <FileText className="w-4 h-4 mr-2" />
                    Job Posting
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/recruiter?tab=candidate-preview")
                    }
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/recruiter?tab=interview-tools")
                    }
                  >
                    <Calendar className="w-4 h-4 mr-2" />
                    Interview Tools
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate("/dashboard/recruiter?tab=analytics")
                    }
                  >
                    <BarChart3 className="w-4 h-4 mr-2" />
                    Analytics Dashboard
